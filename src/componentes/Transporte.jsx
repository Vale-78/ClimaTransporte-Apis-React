...
import JsonDataTransport from "../dataTransporte.json";
...
function Transporte() {
  const [dataTransp, setDataTransp] = useState(null)
  const [error, setError] = useState(null);
  useEffect(() => {
       
       setDataTransp(JsonDataTransport);
      }, []);
  ...
  return (
   ...
   <p style={estilos.p}>
     La info que buscás, aquí la encontrarás!!
      ...
      <div>
        {dataTransp===null ? (
          <p style={estilos.p}>Error al obtener datos de la Api:</p>
        ) : (
          <pre>
                <Maps
